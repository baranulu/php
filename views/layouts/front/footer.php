<footer style="background-color: #343a40;" class="text-white py-5" style="position: relative;">
    <div class="container" style="margin-top: auto;">
        <div class="row">
            ...
            <div class="col-md-3">
                <h5>İletişim</h5>
                <p><i class="fas fa-map-marker-alt"></i> Adres: Ankara/Gölbaşı </p>
                <p><i class="fas fa-phone"></i> Telefon: 561 61 61 061 </p>
                <p><i class="fas fa-envelope"></i> Email: iletisim@sattinsattin.com </p>
            </div>
        </div>
